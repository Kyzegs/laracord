...
/**
 * @method static array getGlobalApplicationCommands(int $applicationId, array $query = [])
 * @method static array createGlobalApplicationCommand(int $applicationId, array $data)
 * @method static array getGlobalApplicationCommand(int $applicationId, int $commandId)
 * @method static array editGlobalApplicationCommand(int $applicationId, int $commandId, array $data)
 * @method static array deleteGlobalApplicationCommand(int $applicationId, int $commandId)
 * @method static array bulkOverwriteGlobalApplicationCommands(int $applicationId, array $data)
 * @method static array getGuildApplicationCommands(int $applicationId, int $guildId, array $query = [])
 * @method static array createGuildApplicationCommand(int $applicationId, int $guildId, array $data)
 * @method static array getGuildApplicationCommand(int $applicationId, int $guildId, int $commandId)
 * @method static array editGuildApplicationCommand(int $applicationId, int $guildId, int $commandId, array $data)
 * @method static array deleteGuildApplicationCommand(int $applicationId, int $guildId, int $commandId)
 * @method static array bulkOverwriteGuildApplicationCommands(int $applicationId, int $guildId, array $data)
 * @method static array getGuildApplicationCommandPermissions(int $applicationId, int $guildId)
 * @method static array getApplicationCommandPermissions(int $applicationId, int $guildId, int $commandId)
 * @method static array editApplicationCommandPermissions(int $applicationId, int $guildId, int $commandId, array $data)
 * @method static array batchEditApplicationCommandPermissions(int $applicationId, int $guildId, array $data)
 * @method static array getCurrentApplication()
 * @method static array getApplicationRoleConnectionMetadataRecords(int $applicationId)
 * @method static array updateApplicationRoleConnectionMetadataRecords(int $applicationId, array $data)
 * @method static array getGuildAuditLog(int $guildId, array $query = [])
 * @method static array listAutoModerationRulesForGuild(int $guildId)
 * @method static array getAutoModerationRule(int $guildId, int $ruleId)
 * @method static array createAutoModerationRule(int $guildId, array $data)
 * @method static array modifyAutoModerationRule(int $guildId, int $ruleId, array $data)
 * @method static array deleteAutoModerationRule(int $guildId, int $ruleId)
 ...
 * @method static array getGuildScheduledEvent(int $guildId, int $guildScheduledEventId)
 * @method static array modifyGuildScheduledEvent(int $guildId, int $guildScheduledEventId, array $data)
 * @method static array deleteGuildScheduledEvent(int $guildId, int $guildScheduledEventId)
 * @method static array getGuildScheduledEventUsers(int $guildId, int $guildScheduledEventId)
 ...
 * @method static array getWebhookMessage(int $webhookId, string $webhookToken, int $messageId)
 * @method static array editWebhookMessage(int $webhookId, string $webhookToken, int $messageId, array $data)
 * @method static array deleteWebhookMessage(int $webhookId, string $webhookToken, int $messageId)
 *
